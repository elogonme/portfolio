const projects = [
    ...
    },
    {
        ...
        repoUrl: "https://github.com/elogonme/WindowShoppin",
        description: `is a personal tracking cart to monitor for price drop and notify! Full Stack application built using Node.js, 
        Express.js, Handlebars, Puppeteer high-level API to control Chromium to scrape websites for data. User authorization
        using Passport.js library, Squelize ORM and MySQL to store data.`,
    },
    {
        ...
        description: `Help people to find person of interest based on names and some funny facts, 
            ...
            compatibility with people you have recently met based on name and date of birth.`
    },
    {
    ...
    },
    {
        ...
        description: `is a restaurant app that lets users input the names of burgers they'd like to eat. 
            ...
            Codebase is following the Model View Controller (MVC). Using Node and MySQL to query and route data in the app, 
            and Handlebars to generate page HTML.`
    },
    {
    ...
    },
    {
        ...
        description: `Shopper App - Personal Shopping List Web App for convenient grocery shopping - My personal 
            ...
            implemented using Angular/NestJS and PostgresSQL database.`
    },
    {
        title: "ROVCalc",
        url: "http://rovel.ca/",
    ...
    },
    {
        ...
        description: `is the app to control LIFX light strip remotely over internet. 
            ...
            I made this app and had colorful lights set up in my room. Friends would access it and make choices to send me vibes and emotions. 
            Frontend app is built using Materialize framework, jQuery and Handlebars.js to populate buttons.
            Backend server built using node.js and running express.js server to add user API Key and proxy requests to LIFX 
            light API, this would hide API key to keep it private. App also can be used during zoom meetings where other 
            user can change background lighting of his companion.`
    },
    ];
